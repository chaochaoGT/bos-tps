...
<script type="text/javascript">
	...
	$(function(){
		$("input[name='checkcode']").blur(function(){
			...
			//  ajax   ....   checkcode_flag  true/false
			$.post("${pageContext.request.contextPath}/userAction_validCheckCode",{"checkcode":this.value},function(data){
				if(data){
					//  用户span提示  
					$("#checkcode_sp").html("√");
					checkcode_flag = true;
...
<body>
	...
	<div class="main-inner" id="mainCnt"
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginFunc">
				<div id="lbNormal" class="loginFuncMobile">员工登录
				</div>
			</div>
			<div class="loginForm">
			<s:actionerror/>
			<s:fielderror/>
				<form id="loginform" name="loginform" method="post" class="niceform"
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<a href="javascript:void(0);" id="loginform:j_id19" name="loginform:j_id19" onclick="mygo();">
						<span
