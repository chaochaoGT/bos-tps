...
// Generated 2017-7-17 11:43:48 by Hibernate Tools 3.2.2.GA
 ...
 */
@Entity
@Table(name = "t_standard", catalog = "heima04_mavenbos", uniqueConstraints = @UniqueConstraint(columnNames = "NAME"))
public class Standard implements java.io.Serializable {
	...
	private Integer deltag = 1;// 1 有效的数据 0 无效数据 逻辑删除使用该标记
